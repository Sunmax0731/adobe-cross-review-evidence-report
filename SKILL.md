...
adobe-cross-review-evidence-report の作業手順です。
...
- asset は `dist/adobe-cross-review-evidence-report-docs.zip`、`docs/manual-test.md`、`docs/strict-manual-test-addendum.md`。
